...
const SubscribeModal = ({products}:SubscribeModalProps) => {
    ...
    const handleCheckout = async (price: Price)=>{
        ...
        if(subscription){
            setPriceIdLoading(undefined)
            return toast('Already susbcribed')
        }
        try{
  ...
  return (
    <Modal title='Only for premium users' description='Join Spotify Premium' isOpen={subscribeModal.isOpen} onChange={onChange}>
        {content}
    </Modal>
  )
}
